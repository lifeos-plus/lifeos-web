...
safe to remove from LifeOS Web API payloads. It intentionally does not mutate
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Also count references inside src/services/api.",
    )
    parser.add_argument(
        "--all",
        action="store_true",
