      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-base-100  border-b border-base-200">
            <tr>
              {isSelectMode && (
                <th className="px-4 py-3 text-center text-xs  text-base-content uppercase tracking-wider w-12">
                  <Checkbox
                    id="select-all"
                    name="select-all"
                    checked={
              ...
              <th className="px-4 py-3 text-left text-xs  text-base-content uppercase tracking-wider w-24">
                {t("timeLog.table.date")}
              </th>
              <th className="px-4 py-3 text-left text-xs  text-base-content uppercase tracking-wider w-32">
              ...
              <th className="px-4 py-3 text-left text-xs  text-base-content uppercase tracking-wider w-20">
                {t("timeLog.table.duration")}
              </th>
              <th className="px-4 py-3 text-left text-xs  text-base-content uppercase tracking-wider w-28">
                {queryMode === "single" ? (
                  <AreaSelect
                    value={
              ...
              <th className="px-4 py-3 text-left text-xs  text-base-content uppercase tracking-wider">
              ...
              <th className="px-4 py-3 text-center text-xs  text-base-content uppercase tracking-wider w-28">
                {t("common.actions")}
              </th>
            </tr>
          </thead>
