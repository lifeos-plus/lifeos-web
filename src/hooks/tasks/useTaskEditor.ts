...
export interface TaskEditResultPayload {
  updatedTask?: {
    ...
    person?: TaskWithSubtasks["person"];
  };
  ...
  const initializeForm = useCallback(() => {
    if (task) {
      setFormData({
        ...
        person_ids: task.person?.map((person) => person.id) || [],
        planning_cycle_type:
            ...
            if (visionChanged) {
              ...
              onSave?.({
                updatedTask: {
                  ...
                  planning_cycle_start_date:
                    formData.planning_cycle_start_date || null,
                  person: latestUpdatedTask?.person ?? task.person ?? undefined,
                },
                structureChanged:
                  visionChanged ||
              ...
              onSave?.({
                updatedTask: {
                  ...
                  planning_cycle_start_date:
                    formData.planning_cycle_start_date || null,
                  person: updatedTask.person ?? task.person ?? undefined,
                },
                structureChanged:
                  (task.parent_task_id || null) !==
                  (formData.parent_task_id || null),
